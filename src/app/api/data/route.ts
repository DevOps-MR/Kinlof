...
const HeaderData: HeaderType[] = [
  ...
  { label: 'Servicios', href: '/#courses  ' },
  { label: 'Equipo', href: '/#mentor' },
  { label: 'Contacto', href: '/#contact' },
  { label: 'Articulos', href: '/#contact' },
...
const CourseData: CourseType[] = [
  {
    heading: 'Diseño de páginas WEB',
    name: 'Pagina principal + alojamiento + dominio',
  ...
  {
    heading: 'Diseño de sistemas multiplataforma',
  ...
  {
    heading: 'Analítica de datos',
    name: 'ETL pipelines + Estandarización de datos + Visualización + Reportes',
  ...
  {
    heading: 'Diseño de sistema iot',
    name: 'Web + Android + iOS + Hardware',
...
const MentorData: MentorType[] = [
  {
    profession: 'Ingeniero en computación e informática',
    name: 'Francisco Mora',
